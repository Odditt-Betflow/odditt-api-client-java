...
|**eventBettingMarketPositionId** | **Long** | The event betting market position to build the cart for. |  |
...
|**useCartoonImages** | **Boolean** | When true, swaps default operator/jersey imagery for cartoon variants. |  [optional] |
